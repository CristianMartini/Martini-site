  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 md:px-12">
        {/* Título da Seção */}
        <motion.h2
          className="text-3xl md:text-4xl lg:text-5xl font-bold text-center mb-8 md:mb-12 text-white dark:text-gray-100"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
          ...
          {/* Formação Acadêmica */}
          <motion.div
            className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 md:p-8 transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl"
          ...
          >
            ...
            <div className="space-y-6">
              {/* Formação 1 */}
              <div>
                <h4 className="text-lg md:text-xl font-semibold text-gray-800 dark:text-gray-200">Sistemas para Internet</h4>
              ...
              {/* Formação 2 */}
              <div>
                <h4 className="text-lg md:text-xl font-semibold text-gray-800 dark:text-gray-200">Bacharel em Ciências Contábeis</h4>
          ...
          >
            ...
            <div className="space-y-6">
              {/* Experiência 1 */}
              <div>
                <h4 className="text-lg md:text-xl font-semibold text-gray-800 dark:text-gray-200">Auxiliar de Produção e Gestor de Serviços</h4>
              ...
              {/* Experiência 2 */}
              <div>
                <h4 className="text-lg md:text-xl font-semibold text-gray-800 dark:text-gray-200">Gestor de Serviços Domésticos</h4>
                <p className="text-gray-700 dark:text-gray-300">
        ...
        <div className="text-center mt-12 md:mt-16">
          <motion.a
            href="/assets/download/Cristian-Martini-Curriculo.pdf" 
            download
