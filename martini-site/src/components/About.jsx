  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 md:px-12">
        {/* Título da Seção */}
        <motion.h2
          className="text-3xl md:text-4xl lg:text-5xl font-bold text-center mb-6 md:mb-8 text-white dark:text-gray-100"
        ...
        {/* Conteúdo */}
        <motion.div
          className="text-white dark:text-gray-200 text-base sm:text-lg md:text-xl leading-relaxed max-w-4xl mx-auto"
          initial={{ opacity: 0 }}
